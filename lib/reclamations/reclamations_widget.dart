...
import '../components/suppreclamation_widget.dart';
...
import '../plaintes/plaintes_widget.dart';
...
class ReclamationsWidget extends StatefulWidget {
  const ReclamationsWidget({Key key}) : super(key: key);

  @override
  _ReclamationsWidgetState createState() => _ReclamationsWidgetState();
}

class _ReclamationsWidgetState extends State<ReclamationsWidget> {
          ...
          child: FloatingActionButton.extended(
            onPressed: () async {
              await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PlaintesWidget(),
                ),
              );
            },
        ...
        child: GestureDetector(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: StreamBuilder<List<PlaintesRecord>>(
                  stream: queryPlaintesRecord(
                    queryBuilder: (plaintesRecord) =>
                        plaintesRecord.orderBy('createdTime', descending: true),
                  ),
                  builder: (context, snapshot) {
                    ...
                    List<PlaintesRecord> listViewPlaintesRecordList =
                        snapshot.data;
                    if (listViewPlaintesRecordList.isEmpty) {
                      return Image.asset(
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewPlaintesRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewPlaintesRecord =
                            listViewPlaintesRecordList[listViewIndex];
                        return Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(8, 0, 8, 10),
                          child: StreamBuilder<UsersRecord>(
                            stream: UsersRecord.getDocument(
                                listViewPlaintesRecord.user),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                                                        ...
                                                        return Padding(
                                                          padding:
                                                              MediaQuery.of(
                                                                  ...
                                                                  .viewInsets,
                                                          child:
                                                              SuppreclamationWidget(
                                                            ref:
                                                                listViewPlaintesRecord
                                                                    .reference,
                                                          ),
                                                        );
                                                      },
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Hero(
                                            tag:
                                                listViewPlaintesRecord.imageUrl,
