...
class AssdemandeWidget extends StatefulWidget {
  const AssdemandeWidget({Key key}) : super(key: key);

  @override
  _AssdemandeWidgetState createState() => _AssdemandeWidgetState();
}

class _AssdemandeWidgetState extends State<AssdemandeWidget> {
        ...
        child: GestureDetector(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: StreamBuilder<List<AssociationsRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<AssociationsRecord> listViewAssociationsRecordList =
                        snapshot.data;
                    if (listViewAssociationsRecordList.isEmpty) {
                      return Image.asset(
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewAssociationsRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewAssociationsRecord =
                            listViewAssociationsRecordList[listViewIndex];
                        return Visibility(
                          visible:
                              (listViewAssociationsRecord.isverified) == false,
                          child: Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(8, 0, 8, 10),
                            child: StreamBuilder<UsersRecord>(
                              stream: UsersRecord.getDocument(
                                  listViewAssociationsRecord.user),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                onTap: () async {
                                                  ...
                                                  final associationsUpdateData =
                                                      createAssociationsRecordData(
                                                    isverified: true,
                                                  );
                                                  await listViewAssociationsRecord
                                                      .reference
                                                      .update(
                                                          associationsUpdateData);
                                                },
                                                child: Text(
                                                  'Accepter',
                                                  style: FlutterFlowTheme.of(
