...
class NewfinanceWidget extends StatefulWidget {
  const NewfinanceWidget({Key key}) : super(key: key);

  @override
  _NewfinanceWidgetState createState() => _NewfinanceWidgetState();
}

class _NewfinanceWidgetState extends State<NewfinanceWidget> {
                              ...
                              if ((dropDownValue != null) &&
                                ...
                                if ((textController1.text != null) &&
                                  ...
                                  if ((textController2.text != null) &&
                                    ...
                                    if ((dropDownValue) == 'Banque') {
                                      final banquesCreateData =
                                          createBanquesRecordData(
                                        nom: textController1.text,
                                        tel1: textController2.text,
                                        tel2: textController3.text,
                                        tel3: textController4.text,
                                      );
                                      await BanquesRecord.collection
                                          .doc()
                                          .set(banquesCreateData);
                                      return;
                                    } else {
                                      if ((dropDownValue) == 'Poste') {
                                        final postesCreateData =
                                            createPostesRecordData(
                                          nom: textController1.text,
                                          tel1: textController2.text,
                                          tel2: textController3.text,
                                          tel3: textController4.text,
                                        );
                                        await PostesRecord.collection
                                            .doc()
                                            .set(postesCreateData);
                                        return;
                                      } else {
                                        if ((dropDownValue) == 'Assurance') {
                                          final assurancesCreateData =
                                              createAssurancesRecordData(
                                            nom: textController1.text,
                                            tel1: textController2.text,
                                            tel2: textController3.text,
                                            tel3: textController4.text,
                                          );
                                          await AssurancesRecord.collection
                                              .doc()
                                              .set(assurancesCreateData);
                                          return;
                                        } else {
                                          if ((dropDownValue) == 'Comptable') {
                                            final comptablesCreateData =
                                                createComptablesRecordData(
                                              nom: textController1.text,
                                              tel1: textController2.text,
                                              tel2: textController3.text,
                                              tel3: textController4.text,
                                            );
                                            await ComptablesRecord.collection
                                                .doc()
                                                .set(comptablesCreateData);
                                            return;
                                          } else {
                                            return;
                                          }
