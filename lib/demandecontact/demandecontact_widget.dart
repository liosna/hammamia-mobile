...
import '../components/suppdemcontact_widget.dart';
...
class DemandecontactWidget extends StatefulWidget {
  const DemandecontactWidget({Key key}) : super(key: key);

  @override
  _DemandecontactWidgetState createState() => _DemandecontactWidgetState();
}

class _DemandecontactWidgetState extends State<DemandecontactWidget> {
        ...
        child: GestureDetector(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: StreamBuilder<List<DemandescontactRecord>>(
                  stream: queryDemandescontactRecord(),
                  builder: (context, snapshot) {
                    ...
                    List<DemandescontactRecord>
                        listViewDemandescontactRecordList = snapshot.data;
                    if (listViewDemandescontactRecordList.isEmpty) {
                      return Image.asset(
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewDemandescontactRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewDemandescontactRecord =
                            listViewDemandescontactRecordList[listViewIndex];
                        return Padding(
                          ...
                          child: Card(
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0, 4, 0, 0),
                                        child: Text(
                                          listViewDemandescontactRecord.emploi,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyText2
                                              .override(
                                                fontFamily: 'Nunito',
                                            ...
                                            builder: (context) {
                                              return Padding(
                                                padding: MediaQuery.of(context)
                                                    .viewInsets,
                                                child: SuppdemcontactWidget(
                                                  ref:
                                                      listViewDemandescontactRecord
                                                          .reference,
                                                ),
                                              );
                                            },
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            4, 0, 0, 0),
                                        child: Text(
                                          listViewDemandescontactRecord.nom,
                                          style: FlutterFlowTheme.of(context)
                                              .subtitle1
                                              .override(
                                                fontFamily: 'Lexend Deca',
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            4, 0, 0, 0),
                                        child: Text(
                                          listViewDemandescontactRecord.tel1,
                                          style: FlutterFlowTheme.of(context)
                                              .subtitle1
                                              .override(
                                                fontFamily: 'Lexend Deca',
                                ...
                                if ((listViewDemandescontactRecord.tel2 !=
                                        null) &&
                                    (listViewDemandescontactRecord.tel2 != ''))
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        12, 0, 12, 2),
                                    child: Row(
                                ...
                                if ((listViewDemandescontactRecord.tel3 !=
                                        null) &&
                                    (listViewDemandescontactRecord.tel3 != ''))
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        12, 0, 12, 5),
                                    child: Row(
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: InkWell(
                                        ...
                                        await Navigator.push(
                                          ...
                                          PageTransition(
                                            ...
                                            child: FlutterFlowExpandedImageView(
                                              ...
                                              allowRotation: false,
                                              tag: listViewDemandescontactRecord
                                                  .photo,
                                      ...
                                      child: Hero(
                                        tag:
                                            listViewDemandescontactRecord.photo,
