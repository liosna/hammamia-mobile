...
import '../pagereservation/pagereservation_widget.dart';
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    await Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            PagereservationWidget(
                                          datee: calendarSelectedDay?.start,
                                        ),
                                      ),
                                    );
                                  },
                          ...
                          StreamBuilder<List<ReservationsfinalRecord>>(
                            stream: queryReservationsfinalRecord(
                              queryBuilder: (reservationsfinalRecord) =>
                                  reservationsfinalRecord.orderBy('fin'),
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<ReservationsfinalRecord>
                                  listViewReservationsfinalRecordList =
                                  snapshot.data;
                              return ListView.builder(
                                ...
                                itemCount:
                                    listViewReservationsfinalRecordList.length,
                                itemBuilder: (context, listViewIndex) {
                                  final listViewReservationsfinalRecord =
                                      listViewReservationsfinalRecordList[
                                          listViewIndex];
                                  return Visibility(
                                    visible: (listViewReservationsfinalRecord
                                            .date) ==
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      listViewReservationsfinalRecord
                                                          .type,
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyText1
