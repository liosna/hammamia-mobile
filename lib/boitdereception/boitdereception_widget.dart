...
import '../components/suppmessage_widget.dart';
...
class BoitdereceptionWidget extends StatefulWidget {
  const BoitdereceptionWidget({Key key}) : super(key: key);

  @override
  _BoitdereceptionWidgetState createState() => _BoitdereceptionWidgetState();
}

class _BoitdereceptionWidgetState extends State<BoitdereceptionWidget> {
