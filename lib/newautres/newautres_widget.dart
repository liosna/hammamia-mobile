...
class NewautresWidget extends StatefulWidget {
  const NewautresWidget({Key key}) : super(key: key);

  @override
  _NewautresWidgetState createState() => _NewautresWidgetState();
}

class _NewautresWidgetState extends State<NewautresWidget> {
                              ...
                              if ((dropDownValue != null) &&
                                ...
                                if ((nomController.text != null) &&
                                  ...
                                  if ((tel1Controller.text != null) &&
                                      (tel1Controller.text != '')) {
                                    if ((dropDownValue) == 'Climatisation') {
                                      final climatisationCreateData =
                                          createClimatisationRecordData(
                                        nom: nomController.text,
                                        tel1: tel1Controller.text,
                                        tel2: tel2Controller.text,
                                        tel3: tel3Controller.text,
                                      );
                                      await ClimatisationRecord.collection
                                          .doc()
                                          .set(climatisationCreateData);
                                      setState(() {
                                        nomController?.clear();
                                      ...
                                      if ((dropDownValue) == 'Forgeron') {
                                        final forgeronsCreateData =
                                            createForgeronsRecordData(
                                          nom: nomController.text,
                                          tel1: tel1Controller.text,
                                          tel2: tel2Controller.text,
                                          tel3: tel3Controller.text,
                                        );
                                        await ForgeronsRecord.collection
                                            .doc()
                                            .set(forgeronsCreateData);
                                        setState(() {
                                          nomController?.clear();
                                          tel1Controller?.clear();
                                          tel2Controller?.clear();
                                        ...
                                        if ((dropDownValue) == 'Maçon') {
                                          final maconsCreateData =
                                              createMaconsRecordData(
                                            nom: nomController.text,
                                            tel1: tel1Controller.text,
                                            tel2: tel2Controller.text,
                                            tel3: tel3Controller.text,
                                          );
                                          await MaconsRecord.collection
                                              .doc()
                                              .set(maconsCreateData);
                                          setState(() {
                                            nomController?.clear();
                                            tel1Controller?.clear();
                                            tel2Controller?.clear();
                                          ...
                                          if ((dropDownValue) == 'Menuisier') {
                                            final menuisiersCreateData =
                                                createMenuisiersRecordData(
                                              nom: nomController.text,
                                              tel1: tel1Controller.text,
                                              tel2: tel2Controller.text,
                                              tel3: tel3Controller.text,
                                            );
                                            await MenuisiersRecord.collection
                                                .doc()
                                                .set(menuisiersCreateData);
                                            setState(() {
                                              nomController?.clear();
                                              tel1Controller?.clear();
                                              tel2Controller?.clear();
                                            ...
                                            if ((dropDownValue) == 'Plombier') {
                                              final plombiersCreateData =
                                                  createPlombiersRecordData(
                                                nom: nomController.text,
                                                tel1: tel1Controller.text,
                                                tel2: tel2Controller.text,
                                                tel3: tel3Controller.text,
                                              );
                                              await PlombiersRecord.collection
                                                  .doc()
                                                  .set(plombiersCreateData);
                                              setState(() {
                                                nomController?.clear();
                                                tel1Controller?.clear();
                                                tel2Controller?.clear();
                                              ...
                                              if ((dropDownValue) ==
                                                  'Peintre') {
                                                final peintresCreateData =
                                                    createPeintresRecordData(
                                                  nom: nomController.text,
                                                  tel1: tel1Controller.text,
                                                  tel2: tel2Controller.text,
                                                  tel3: tel3Controller.text,
                                                );
                                                await PeintresRecord.collection
                                                    .doc()
                                                    .set(peintresCreateData);
                                                setState(() {
                                                  nomController?.clear();
                                                  tel1Controller?.clear();
                                                  tel2Controller?.clear();
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          content: Text(
                                              'Veuiller entrer le numéro du téléphone'),
                                          actions: [
                                            TextButton(
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        content: Text('Veuiller entrer le nom'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      content:
                                          Text('Veuiller choisir un métier '),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
