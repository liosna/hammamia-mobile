...
class Doc17arWidget extends StatefulWidget {
  const Doc17arWidget({Key key}) : super(key: key);

  @override
  _Doc17arWidgetState createState() => _Doc17arWidgetState();
}

class _Doc17arWidgetState extends State<Doc17arWidget> {
