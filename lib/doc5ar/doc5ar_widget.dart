...
class Doc5arWidget extends StatefulWidget {
  const Doc5arWidget({Key key}) : super(key: key);

  @override
  _Doc5arWidgetState createState() => _Doc5arWidgetState();
}

class _Doc5arWidgetState extends State<Doc5arWidget> {
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'للبيانات الضرورية : العنوان و مراجع رخصة البناء',
                                    style: FlutterFlowTheme.of(context)
                                        .title2
                                        .override(
                                          fontFamily: 'Somar',
                                  ...
                                  Text(
                                    'شهادة ملكية أو ما يعادلها للعقار موضوع الطلب',
                                    style: FlutterFlowTheme.of(context)
                                        .title2
                                        .override(
                                          fontFamily: 'Somar',
