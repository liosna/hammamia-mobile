...
class TermsetcondiWidget extends StatefulWidget {
  const TermsetcondiWidget({Key key}) : super(key: key);

  @override
  _TermsetcondiWidgetState createState() => _TermsetcondiWidgetState();
}

class _TermsetcondiWidgetState extends State<TermsetcondiWidget> {
