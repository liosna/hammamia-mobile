...
class PagereservationWidget extends StatefulWidget {
  const PagereservationWidget({
    Key key,
    this.datee,
  }) : super(key: key);
  ...
  @override
  _PagereservationWidgetState createState() => _PagereservationWidgetState();
}

class _PagereservationWidgetState extends State<PagereservationWidget> {
  ...
  void initState() {
    ...
    nomController = TextEditingController(
        text:
            '${currentUserDisplayName} ${valueOrDefault(currentUserDocument?.prenom, '')}');
    typeController = TextEditingController();
    telephoneController = TextEditingController(text: currentPhoneNumber);
  }
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    dateTimeFormat('d/M/y', widget.datee),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
                                    ...
                                    if ((datePicked1 != null)) {
                                      if ((datePicked2 != null)) {
                                        if ((datePicked2) > (datePicked1)) {
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                content: Text(
                                                    'L\'heure de la fin ne peut pas être inférieure à l\'heure du début'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              content: Text(
                                                  'Veuiller choisir l\'heure de la fin'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            content: Text(
                                                'Veuiller choisir l\'heure du début'),
                                            actions: [
                                              TextButton(
