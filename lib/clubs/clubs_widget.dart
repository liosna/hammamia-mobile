                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: Container(
                                                    decoration: BoxDecoration(),
                                                    child: Text(
                                                      'Le Tennis Club de Hammam Sousse, également connu sous le nom du TCHS, est un club de tennis créé en 1988 qui réunit 8 courts découverts.',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyText1
                                                          .override(
                                                ...
                                                Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      await launchURL(
                                                          'https://www.facebook.com/TCHS2019/?ref=page_internal');
                                                    },
                                                    text: 'Plus',
                                                    options: FFButtonOptions(
                                                      width: 80,
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      await launchURL(
                                                          'https://www.facebook.com/anis.benabdallah.5');
                                                    },
                                                    text: 'Plus',
                                                    options: FFButtonOptions(
                                                      width: 80,
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      await launchURL(
                                                          'https://www.facebook.com/Club-Nautique-Hammam-Sousse-111872264459483/?ref=page_internal');
                                                    },
                                                    text: 'Plus',
                                                    options: FFButtonOptions(
                                                      width: 80,
                        ...
                        Padding(
                          padding:
                              EdgeInsetsDirectional.fromSTEB(40, 15, 40, 20),
                          child: Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(35),
                              border: Border.all(
