...
class ServicecivilfrWidget extends StatefulWidget {
  const ServicecivilfrWidget({Key key}) : super(key: key);

  @override
  _ServicecivilfrWidgetState createState() => _ServicecivilfrWidgetState();
}

class _ServicecivilfrWidgetState extends State<ServicecivilfrWidget> {
