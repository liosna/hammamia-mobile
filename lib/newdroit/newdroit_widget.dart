...
class NewdroitWidget extends StatefulWidget {
  const NewdroitWidget({Key key}) : super(key: key);

  @override
  _NewdroitWidgetState createState() => _NewdroitWidgetState();
}

class _NewdroitWidgetState extends State<NewdroitWidget> {
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FlutterFlowDropDown(
                                      options: ['Avocat', 'Huissier', 'Notaire']
                                          .toList(),
                                      onChanged: (val) =>
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                if ((dropDownValue) == 'Avocat') {
                                  final avocatsCreateData =
                                      createAvocatsRecordData(
                                    nom: textController1.text,
                                    tel1: textController2.text,
                                    tel2: textController3.text,
                                    tel3: textController4.text,
                                  );
                                  await AvocatsRecord.collection
                                      .doc()
                                      .set(avocatsCreateData);
                                  setState(() {
                                  ...
                                  if ((dropDownValue) == 'Huissier') {
                                    final huissiersCreateData =
                                        createHuissiersRecordData(
                                      nom: textController1.text,
                                      tel1: textController2.text,
                                      tel2: textController3.text,
                                      tel3: textController4.text,
                                    );
                                    await HuissiersRecord.collection
                                        .doc()
                                        .set(huissiersCreateData);
                                    setState(() {
                                      textController1?.clear();
                                      textController2?.clear();
                                      textController3?.clear();
                                    ...
                                    if ((dropDownValue) == 'Notaire') {
                                      final notairesCreateData =
                                          createNotairesRecordData(
                                        nom: textController1.text,
                                        tel1: textController2.text,
                                        tel2: textController3.text,
                                        tel3: textController4.text,
                                      );
                                      await NotairesRecord.collection
                                          .doc()
                                          .set(notairesCreateData);
                                      setState(() {
                                        textController1?.clear();
                                        textController2?.clear();
                                        textController3?.clear();
